...
The methodology for deriving these indexes is based on an unsupervised machine learning approach.
The indexes enable the objective comparison of visual oak health over large geographical areas and over the course of numerous growing seasons. 

This work is a progression of previous research on Acute Oak Decline symptom expression by my co-authors Nathan Brown and Sandra Denman, published in this journal.
...
For this reason, we feel that Forest Ecology and Management is the ideal journal for presenting this novel methodology.
