...
```{r descriptor_adjustment,fig.cap='Exapmle of overall mean adjustment applied to the diameter at breast height descriptor. Error bars show ±1SE of the mean. Dashed red line shows the overall mean.'}
