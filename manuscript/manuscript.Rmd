...
**Composite crown volume (m^3^)** - Estimated volume of crown as an paraboloid proportional to the crown condition. Based on the composite crown volumne from @zarnoch2004 but uses crown condition instead of crown density alone.
