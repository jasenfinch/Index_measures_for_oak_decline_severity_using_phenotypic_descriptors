...
A similar process was used for the DAI using also a comparison between active bleed size and black staining size as well as missing crown and crown transparency.
Cases included neutral, moderate and severe AOD and COD decline types.

- reduced by a factor of 16 for clearer visualisation
