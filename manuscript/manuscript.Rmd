...
An example of this adjustment is shown for DBH in Supplementary Figure # and the adjustment factors for each of the descriptors at each site is shown in Supplementary Table #.  
...
The descriptors that contributed most to this discrimination were those that were related to trees size such as DBH, total height and crown radius and likely reflect the varied tree age and planting density across the nine sites (Supplementary figure #b). 
...
The top four ranked descriptors found to contribute to the PDI index model were all crown size and condition related descriptors with crown volume the top ranked descriptor overall (Figure #a).
Other tree size related descriptors such as and stem bleeding descriptors such as contributed secondarily.

The DAI was more complex in descriptor contribution many more descriptors contributing more equally than the PDI (Figure #b).
...
Plots of the individual descriptors against the decline indexes are available in Supplementary figures #-#. 
...
LIME identified crown volume, condition transparency and radius as the top four descriptors contributing to the PDI in each of the healthy, moderate and severe decline cases using lime (Table #).
...
For the DAI, a number of different descriptors were found to be locally important to the decline type cases compared to the overall model importance such as crown contact (Table #).
...
A much greater range of PDI values can be obtained from trees with relatively greater stature (e.g. greater crown radius, total height, lower crown height and DBH; Figures #a & b), with relatively small stature trees having PDIs of 0.5 or greater even with 100% crown condition.
...
These response surfaces show circumstances under which bleed prevalence related descriptors (Figures #a, b & c) and crown condition descriptors (Figures #d, e & f) change for non-symptomatic AOD or COD trees (Figures #a & d respectively), moderate AOD or COD (Figures #b & e respectively) and severe AOD or COD (Figures #c & f respectively). 
...
The two dimensional space provided by these phenotypic indexes, for measuring decline severity is shown in Figure #. 
