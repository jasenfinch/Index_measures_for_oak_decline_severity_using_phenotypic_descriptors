...
The first MDS dimension was min-max scaled to give a scale between 0 and 1 with more severely declining trees having a score closer to 1.
This dimension was named the PDI.
The second MDS dimension ($D$) was first inverted ($1 - D$) to ensure the correct dimension orientation relative to decline type.
...
- Scale inversion likely need with new data
