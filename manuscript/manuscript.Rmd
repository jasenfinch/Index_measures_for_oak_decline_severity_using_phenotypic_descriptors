...
- 12 figure grid reference for each tree
- DBH to nearest 0.1cm
- Total height to nearest 0.1m
- Timber height - either 7cm top diameter or where no main stem can be distinguished
- Lowest live crown to nearest 0.1m
- Social class
...
- Canopy closure recorded as yes or no depending on whether any other crowns are touching the sampling tree.
- High resolution photo collected from the vase to the spring of the crown on each cardinal point
- High resolution photo of stem from the base to a height of 3m

- Canopy closure percentage
- Presence or absence of pruning damage or branch loss from main stem
- % missing crown excluded from crown density assessment
- absolute crown density in 5% classes
- dieback type
- main crown dieback location
- stem epicormic growth
- branch epicormic growth
- insect damage on leaves and type
- crown mildew
...
### Descriptor contribution decline indexes
...
The example cases were identified by selecting the descriptor values for trees with PDI values closes to the 25, 50 and 75% quantiles for the healthy, moderate and severely declining trees respectively.
...
Cases included neutral, moderate and severe with DAI scores closest to 0, 0.5 and 1 respectively for AOD and 0, -0.5 and -1 respectively for COD.
