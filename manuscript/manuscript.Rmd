...
Here, we propose a framework for quantitatively measuring the phenotypic severity of oak decline that is based on unsupervised random forest machine learning 
