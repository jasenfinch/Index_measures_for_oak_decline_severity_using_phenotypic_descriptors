...
source('../code/figures/library_load.R')
```

```{r prep}
source('../code/figures/data_prep.R')
```
...
Oak decline syndromes are facilitated by a variety of both biotic and abiotic factors 
...
Large phenotypic differences were found between the sites by supervised random forest (Figure \@ref(fig:siteLocations))
