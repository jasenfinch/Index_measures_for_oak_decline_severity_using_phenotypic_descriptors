...
descriptorInfo <- function(analysisTable){
  ...
  type <- tribble(
    ...
    'Agrilus exit holes','Number of *Agrilus* exit holes from the tree base to a height of 2m.','frequency','',
    ...
    'Active bleed size (mm)','Average active bleed size in the 3m section from the base of the tree.','mm','',
    'Black staining','Number of black stains in the 3m section from the base of the tree. Inactive bleeds.','fequency','',
    'Black staining size (mm)','Average black stain size in the 3m section from the base of the tree.','mm','',
    'Calloused wound','Number of callused wounds in the 3m section from the base of the tree. Scars.','frequency','',
    'Calloused wound size (mm)','Average callouse wound size in the 3m section from the base of the tree.','mm',''
  ) %>%
